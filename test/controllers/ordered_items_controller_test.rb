...
class OrderedItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ordered_item" do
    assert_difference("OrderedItem.count") do
      post ordered_items_url, params: { ordered_item: { order_id: @ordered_item.order_id, price_in_cents: @ordered_item.price_in_cents, product_id: @ordered_item.product_id, quantity: @ordered_item.quantity } }
    end
  ...
  test "should update ordered_item" do
    patch ordered_item_url(@ordered_item), params: { ordered_item: { order_id: @ordered_item.order_id, price_in_cents: @ordered_item.price_in_cents, product_id: @ordered_item.product_id, quantity: @ordered_item.quantity } }
